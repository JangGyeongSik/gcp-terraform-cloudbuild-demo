...
2.  ### Git Hub App 연동
    1.  Connect Repository
        ...
        <img src="./image/cloudbuild_github_connect.png" width="500px" title="cloudbuild_options"/>        
    2.  Authenticate → Select Repository 

        <img src="./image/cloudbuild_github_select.png" width="500px" title="cloudbuild_options"/> 

        1.  GitHub 콘텐츠를 기반으로 GCP Project에서의 권한을 GitHub App에게 허용해주는 옵션
3.  ### Configuration
    <img src="./image/cloudbuild_configuration.png" width="500px" title="cloudbuild_options"/>        
    ...
    1.  Type
        ...
        3.  DockerFile  
            <img src="./image/cloudbuild_dockerfile.png" width="450px" title="cloudbuild_options"/>
...
4.  ### Advanced
    1.  대체 변수(Substitution variables)
        1.  다른 변수값으로 Cloud Build YAML을 재사용할 수 있습니다.
...
1.  ### GitHub(Terraform Module & Desginated Directory)  
    ...
    <img src="./image/github_tree.png" width="450px" title="github_tree"/>
 
    1.  Cloud Build Architecture에 해당하는 cloudbuild.yaml은 gcp-terraform-deploy Directory에 Update 하였습니다. 

2.  ### GitHub Repo에 cloudbuild.yaml Push
    1.  Access Approval이 활성화 되어 있어, 아래와 같이 승인 절차 진행
        <img src="./image/cloudbuild_approval.png" width="1000px" title="cloudbuild_options"/>
    2.  승인 이후 cloudbuild.yaml에 명시한 대로 Terraform Command 진행
        1.  Cloud Build Logs
            <img src="./image/cloudbuild_logs.png" width="1000px" title="cloudbuild_options"/>
        2.  Compute Engine List
            <img src="./image/gcp_gce_list.png" width="1000px" title="gcp_instances_list"/>
